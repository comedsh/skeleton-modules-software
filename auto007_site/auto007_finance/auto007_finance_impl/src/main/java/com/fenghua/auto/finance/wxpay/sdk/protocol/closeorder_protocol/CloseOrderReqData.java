...
public class CloseOrderReqData {
    ...
    private String transaction_id = "";	//否——微信的订单号，优先使用
    private String out_trade_no = "";	//否——商户系统内部的订单号，当没提供transaction_id时需要传这个。
    ...
    public CloseOrderReqData(String transactionID,String outTradeNo){
