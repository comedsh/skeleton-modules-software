...
//这个就是自己要保管好的私有Key了（切记只能放在自己的后台代码里，不能放在任何可能被看到源代码的客户端程序中）
	...
	public static String HttpsRequestClassName = "com.fenghua.auto.finance.wxpay.sdk.common.HttpsRequest";
	public static void setCallbackUrl(String callbackUrl) {
		Configure.callbackUrl = callbackUrl;
	}
