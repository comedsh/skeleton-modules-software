package com.fenghua.auto.finance.wxpay.sdk;

import com.fenghua.auto.finance.wxpay.sdk.business.DownloadBillBusiness;
import com.fenghua.auto.finance.wxpay.sdk.business.RefundBusiness;
import com.fenghua.auto.finance.wxpay.sdk.business.RefundQueryBusiness;
import com.fenghua.auto.finance.wxpay.sdk.business.ScanPayBusiness;
...
import com.fenghua.auto.finance.wxpay.sdk.protocol.downloadbill_protocol.DownloadBillReqData;
import com.fenghua.auto.finance.wxpay.sdk.protocol.pay_protocol.ScanPayReqData;
import com.fenghua.auto.finance.wxpay.sdk.protocol.pay_query_protocol.ScanPayQueryReqData;
import com.fenghua.auto.finance.wxpay.sdk.protocol.refund_protocol.RefundReqData;
import com.fenghua.auto.finance.wxpay.sdk.protocol.refund_query_protocol.RefundQueryReqData;
import com.fenghua.auto.finance.wxpay.sdk.service.CloseOrderService;
import com.fenghua.auto.finance.wxpay.sdk.service.DownloadBillService;
import com.fenghua.auto.finance.wxpay.sdk.service.RefundQueryService;
import com.fenghua.auto.finance.wxpay.sdk.service.RefundService;
import com.fenghua.auto.finance.wxpay.sdk.service.ScanPayQueryService;
import com.fenghua.auto.finance.wxpay.sdk.service.ScanPayService;
...
public class WXPay {
    ...
    public static void initSDKConfiguration(String key,String appID,String mchID,String sdbMchID,
    		String certLocalPath,String certPassword, String callbackUrl){
        ...
        Configure.setCallbackUrl(callbackUrl);
    }
     ...
     * @throws Exception
     */
	public static String requestCloseOrderService(CloseOrderReqData reverseReqData) throws Exception{
		return new CloseOrderService().request(reverseReqData);
	}
