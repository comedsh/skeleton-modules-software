package com.fenghua.auto.finance.wxpay.sdk.business;
...
import com.fenghua.auto.finance.wxpay.sdk.common.Log;
import com.fenghua.auto.finance.wxpay.sdk.common.Signature;
import com.fenghua.auto.finance.wxpay.sdk.common.Util;
import com.fenghua.auto.finance.wxpay.sdk.common.report.ReporterFactory;
import com.fenghua.auto.finance.wxpay.sdk.common.report.protocol.ReportReqData;
import com.fenghua.auto.finance.wxpay.sdk.common.report.service.ReportService;
import com.fenghua.auto.finance.wxpay.sdk.protocol.closeorder_protocol.CloseOrderReqData;
import com.fenghua.auto.finance.wxpay.sdk.protocol.closeorder_protocol.CloseOrderResData;
...
public class ScanPayBusiness {
    ...
    public ScanPayBusiness() throws IllegalAccessException, ClassNotFoundException, InstantiationException {
        ...
        reverseService = new CloseOrderService();
    }
    ...
    public interface ResultListener {
        ...
        void onFailByReverseSignInvalid(CloseOrderResData reverseResData);
    ...
    private CloseOrderService reverseService;
    ...
    private boolean doOneReverse(String outTradeNo,ResultListener resultListener) throws Exception {
        ...
        CloseOrderReqData reverseReqData = new CloseOrderReqData("",outTradeNo);
        reverseResponseString = reverseService.request(reverseReqData);

        log.i("撤销API返回的数据如下：");
        log.i(reverseResponseString);
        //将从API返回的XML数据映射到Java对象
        CloseOrderResData reverseResData = (CloseOrderResData) Util.getObjectFromXML(reverseResponseString, CloseOrderResData.class);
    ...
    public void setReverseService(CloseOrderService service) {
